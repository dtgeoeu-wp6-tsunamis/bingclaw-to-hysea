...
def tmp_my_run_workflow_func(scenario, bingclaw_release_volume_dir, bingclaw_scenario, bingclaw_box, bingclaw_resolution):
    import os 
    import sys
    ...
    #scenario   = 'test5466'   # ***Simulation name
    ...
    #bingclaw_scenario = 'volume_id-5466_seed-496--1.asc'                               # ***Name of .tt3 file describing initial conditions for BingClaw simulation
