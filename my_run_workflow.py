...
scenario   = '847174'   # ***Simulation name
...
bingclaw_release_volume_dir = '../../release-volume-sampler_20250602_kl1242/volumes/rasters/'
bingclaw_scenario = 'volume_id-847174_seed-12191--1.asc'                               # ***Name of .tt3 file describing initial conditions for BingClaw simulation
bingclaw_box = [15.38125, 15.68667, 37.94542, 38.11917]            # [Lon min, Lon max, Lat min, Lat max] Geographic coordinates of computational domain
bingclaw_resolution = 40     # Grid resolution in m
...
filter_type = 'none' #'kajiura'                            # ***Filter for deformation data (kajiura / none)
