...
bingclaw_bathymetry = '1520_1570_3770_3810_100m.tt3'  # ***Bathymetry file used in BingClaw simulations
#bingclaw_scenario = scenario + '.asc'                               # ***Name of .tt3 file describing initial conditions for BingClaw simulation
bingclaw_scenario = 'RELEASEVOLUME_4998.asc'                               # ***Name of .tt3 file describing initial conditions for BingClaw simulation
bingclaw_box = [15.35, 15.6, 37.8, 38]            # [Lon min, Lon max, Lat min, Lat max] Geographic coordinates of computational domain
...
donor = 'bingclaw'
bathy_file = 'cutGEBCO_00100_smoothed_2024.nc' #'MessinaGEBCO_forHySEA_HR.nc'   # ***Bathymetry file for interface module (where results of BingClaw are interpolated on)
...
pois_file = 'Messina_pois.dat' # 'Messina_pois_1411_1650_3575_3840.dat'      # ***Name of file with list of POIs for storing time series (relevant if output_time_series is True)
